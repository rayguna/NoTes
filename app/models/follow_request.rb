...
class FollowRequest < ApplicationRecord
  ...
  validate :recipient_and_sender_cannot_be_same, on: :create
  validate :no_duplicate_follow_request, on: :create
  validate :no_reverse_duplicate_follow_request, on: :create
